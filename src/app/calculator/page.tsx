          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <div className="card bg-gradient-to-br from-navy to-navy-light text-white text-center p-8">
              ...
              <div className="flex gap-3 justify-center">
                <Link href="/properties?type=rent-to-own" className="bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-dark transition-colors">
                  Browse Rent-to-Own
                </Link>
                <Link href="/register" className="bg-white/10 border border-white/30 text-white px-6 py-3 rounded-xl font-semibold hover:bg-white/20 transition-colors">
                  Get Started Free
                </Link>
              </div>
            </div>
