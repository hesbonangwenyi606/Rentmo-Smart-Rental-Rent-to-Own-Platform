...
const paymentHistory = [
  { month: "Oct", amount: 85000, status: "paid" },
  { month: "Nov", amount: 85000, status: "paid" },
  { month: "Dec", amount: 85000, status: "paid" },
  { month: "Jan", amount: 85000, status: "paid" },
  { month: "Feb", amount: 85000, status: "paid" },
  { month: "Mar", amount: 85000, status: "paid" },
];
...
const notifications = [
  {
    ...
    desc: "KES 85,000 due on April 18, 2026",
    time: "2h ago",
    icon: AlertCircle,
  ...
  },
  {
    ...
    desc: "Your score increased by 15 points to 720",
    time: "1d ago",
    icon: TrendingUp,
  ...
  },
  {
    ...
    desc: "Your lease expires in 45 days",
    time: "2d ago",
    icon: Calendar,
...
function ScoreGauge({ score }: { score: number }) {
  ...
  const color =
    score >= 700
      ...
      : "#ef4444";
  const label =
    score >= 750 ? "Excellent" : score >= 700 ? "Good" : score >= 650 ? "Fair" : "Needs Work";

  return (
    <div className="flex flex-col items-center">
      <div className="relative w-36 h-20 overflow-hidden mb-3">
        <div className="absolute inset-0 rounded-t-full border-[12px] border-gray-100" style={{ borderBottomColor: "transparent" }} />
        <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-2xl font-bold text-navy">James Kamau 👋</h1>
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-5">
                ...
                <Link href="/properties/1" className="text-xs text-primary flex items-center gap-1 hover:underline">
              ...
              <div className="flex gap-4 items-start">
                <div className="w-24 h-24 rounded-xl bg-gray-100 overflow-hidden shrink-0">
                  ...
                  <img
                    src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=200&q=60"
                    alt="Property"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-3">
                    <div>
                      ...
                      <p className="text-sm font-medium text-navy">Apr 2025 – Apr 2026</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-navy">KES 85,000</p>
                    </div>
                    <div>
              ...
              <div className="mt-5 pt-5 border-t border-gray-100">
                ...
                <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                  <div className="bg-gradient-to-r from-primary to-orange-400 h-full rounded-full transition-all duration-500" style={{ width: "34%" }} />
                </div>
                <p className="text-xs text-gray-400 mt-1.5">
                  ~6.3 years remaining at current payment rate
                </p>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="badge-green flex items-center gap-1">
                  <CheckCircle2 className="w-3 h-3" /> 6 months on time
                </span>
              </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-5">
                ...
                <Link href="/credit-score" className="text-xs text-primary flex items-center gap-1 hover:underline">
          ...
          <div className="space-y-6">
            ...
            <div className="card text-center">
              ...
              <div className="mt-5 grid grid-cols-3 gap-2 text-center">
                ...
                <div className="bg-gray-50 rounded-xl p-3">
                  <p className="text-lg font-bold text-navy">+80</p>
                  <p className="text-xs text-gray-400">Points</p>
                </div>
              </div>
              <Link href="/credit-score" className="btn-outline w-full mt-4 !py-2.5 !text-sm text-center block">
                View Full Report
              </Link>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {quickActions.map((action) => (
                  <Link
                    key={action.label}
                    href={action.href}
                    className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-gray-50 transition-colors border border-gray-100 hover:border-gray-200"
                  >
