...
const myProperties = [
  {
    id: "1",
    title: "Modern 3BR – Kilimani",
    rent: 85000,
    tenant: "James Kamau",
    status: "occupied",
    paymentStatus: "paid",
    image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=200&q=60",
  },
  {
    id: "2",
    title: "Cozy 2BR – Westlands",
    rent: 65000,
    tenant: "Amara Ochieng",
    status: "occupied",
    paymentStatus: "pending",
    image: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=200&q=60",
  },
  {
    id: "3",
    title: "Studio – Lavington",
    rent: 28000,
    tenant: "Vacant",
    status: "vacant",
    paymentStatus: "n/a",
    image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=200&q=60",
  },
  {
    id: "4",
    title: "3BR Townhouse – Parklands",
    rent: 75000,
    tenant: "Fatima Ali",
    status: "occupied",
    paymentStatus: "paid",
    image: "https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=200&q=60",
  },
];
...
export default function LandlordDashboard() {
  ...
  const occupancyRate = Math.round(
    (myProperties.filter((p) => p.status === "occupied").length / myProperties.length) * 100
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-2xl font-bold text-navy">Grace Wanjiku 🏡</h1>
            </div>
            <div className="flex items-center gap-3">
              ...
              <Link href="/properties/add" className="btn-primary !py-2 !px-4 flex items-center gap-2 text-sm">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-5">
                <div>
                  <h2 className="font-bold text-navy text-lg">Revenue Overview</h2>
                  <p className="text-xs text-gray-400 mt-0.5">Monthly rental income collected</p>
                </div>
                ...
                {myProperties.map((p) => (
                  <div key={p.id} className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <Link
                      ...
                      className="p-2 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-navy transition-colors"
                    >
          ...
          <div className="space-y-6">
            ...
            <div className="card bg-navy text-white">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">KES 425,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400 text-sm">Collected</span>
                  <span className="font-semibold text-green-400">KES 360,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400 text-sm">Outstanding</span>
                  <span className="font-semibold text-yellow-400">KES 65,000</span>
                </div>
                <div className="h-px bg-white/10 my-1" />
                <div className="flex justify-between">
                  <span className="text-gray-400 text-sm">Collection Rate</span>
                  <span className="font-bold text-primary">84.7%</span>
                </div>
              </div>
              <div className="mt-4">
            ...
            <div className="card border-2 border-dashed border-primary/30 bg-primary/5 text-center p-6">
              ...
              <Link href="/properties/4" className="btn-primary !py-2 !text-sm w-full text-center block">
                Find Tenant
              </Link>
            </div>
          </div>
