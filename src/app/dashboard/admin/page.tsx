...
const userGrowth = [
  { month: "Oct", tenants: 6200, landlords: 520 },
  { month: "Nov", tenants: 6800, landlords: 560 },
  { month: "Dec", tenants: 7200, landlords: 590 },
  { month: "Jan", tenants: 7700, landlords: 620 },
  { month: "Feb", tenants: 8100, landlords: 650 },
  { month: "Mar", tenants: 8500, landlords: 680 },
];

const revenueFlow = [
  { month: "Oct", revenue: 12.4 },
  { month: "Nov", revenue: 14.1 },
  { month: "Dec", revenue: 15.8 },
  { month: "Jan", revenue: 17.2 },
  { month: "Feb", revenue: 19.5 },
  { month: "Mar", revenue: 21.3 },
];
...
const pendingActions = [
  { id: 1, type: "Listing Approval", title: "5BR Villa – Muthaiga", landlord: "Peter Otieno", time: "2h ago", icon: Building2, color: "text-blue-500 bg-blue-50" },
  { id: 2, type: "Loan Application", title: "KES 50,000 – Rent Loan", tenant: "Susan Njeri", time: "4h ago", icon: DollarSign, color: "text-green-500 bg-green-50" },
  { id: 3, type: "Loan Application", title: "KES 85,000 – Rent Loan", tenant: "David Mwangi", time: "5h ago", icon: DollarSign, color: "text-green-500 bg-green-50" },
  { id: 4, type: "Insurance Claim", title: "Claim #2089 – Basic Plan", tenant: "Mary Wambui", time: "1d ago", icon: Shield, color: "text-purple-500 bg-purple-50" },
];

const recentUsers = [
  { name: "James Kamau", role: "Tenant", location: "Kilimani", score: 720, joined: "Today" },
  { name: "Grace Wanjiku", role: "Landlord", location: "Westlands", score: "-", joined: "Today" },
  { name: "Susan Njeri", role: "Tenant", location: "Lavington", score: 640, joined: "Yesterday" },
  { name: "Peter Otieno", role: "Landlord", location: "Karen", score: "-", joined: "2 days ago" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-2xl font-bold">Rentmo Admin 🛡️</h1>
            </div>
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 pr-4 py-2 bg-white/10 border border-white/20 text-white placeholder-gray-400 rounded-xl text-sm outline-none focus:bg-white/20 transition-colors w-56"
                />
              </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="badge-green flex items-center gap-1">
                  <TrendingUp className="w-3 h-3" /> +72% YoY
                </span>
              </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-5">
                ...
                <Link href="#" className="text-xs text-primary flex items-center gap-1 hover:underline">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-100">
                      ...
                      <th className="text-left text-xs font-medium text-gray-400 pb-3">Location</th>
                      <th className="text-left text-xs font-medium text-gray-400 pb-3">Credit</th>
                      <th className="text-left text-xs font-medium text-gray-400 pb-3">Joined</th>
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {recentUsers.map((u) => (
                      <tr key={u.name} className="hover:bg-gray-50">
                        ...
                        <td className="py-3">
                          <span className={u.role === "Tenant" ? "badge-blue" : "badge-green"}>
                            {u.role}
                          </span>
                        </td>
                        ...
                        <td className="py-3">
                          {u.score !== "-" ? (
                            <span className="font-medium text-navy">{u.score}</span>
                          ) : (
          ...
          <div className="space-y-6">
                ...
                {pendingActions.map((action) => (
                  <div key={action.id} className="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer border border-gray-100 hover:border-gray-200">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400">{action.tenant || action.landlord} · {action.time}</p>
                    </div>
                    <div className="flex gap-1 shrink-0">
                      <button className="p-1 rounded-lg bg-green-50 text-green-600 hover:bg-green-100">
                        <CheckCircle2 className="w-4 h-4" />
                      </button>
                      <button className="p-1 rounded-lg bg-red-50 text-red-500 hover:bg-red-100">
            ...
            <div className="card bg-green-50 border border-green-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="font-bold text-green-800">System Healthy</h2>
              </div>
              <div className="space-y-2 text-sm">
                {[
                  { label: "API Response", value: "98ms", ok: true },
                  { label: "M-Pesa Gateway", value: "Online", ok: true },
                  { label: "Card Payments", value: "Online", ok: true },
                  { label: "SMS Service", value: "Online", ok: true },
                ].map((item) => (
